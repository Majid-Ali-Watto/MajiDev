export const blogs = [
	{
		title: "Pure Function",
		link: "https://medium.com/@majid.teresol/pure-function-dfbdde700777",
		description: "A Pure Function is a function that always returns the same result given the same input and doesn’t cause any side effects. It doesn’t modify variables outside of its scope or perform any I/O operations.",
		imgURL: "/pure-func.webp"
	},
	{

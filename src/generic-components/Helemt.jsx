...
function Helemt_SEO() {
	...
	return (
		<Helmet>
			...
			<meta
				name="keywords"
				content={`${devName}'s portfolio, ${devName}, Vue JS Developer, React JS Developer, Front End Developer, Portfolio, Web Developer, Software Engineer, Projects, Services`}
			/>
			<meta
				name="author"
				content={devName}
